 ...
 */
@Repository
public class RidersWebSocketServer {

    private static Logger log = Logger.getLogger(RidersWebSocketServer.class);
    
    @Config
    private int port = 10009;

    @Autowired
    private RidersWebSocketServerInitializer serverInitializer;
